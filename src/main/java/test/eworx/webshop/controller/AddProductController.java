...
/**
 * AddProductController takes care calls of type
 * Method: GET Url: https://{host}/rest/v1/addProduct?id={productId}
 *
...
public class AddProductController {
    ...
    public DeferredResult<ResponseEntity<SelectedProduct>> addProduct(@RequestParam Map<String, String> parameters,
        ...
        if (!basketAdapter.addToBasket(Integer.valueOf(id))) {
